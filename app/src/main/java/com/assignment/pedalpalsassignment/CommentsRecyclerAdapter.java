...
public class CommentsRecyclerAdapter extends RecyclerView.Adapter<CommentsRecyclerAdapter.ViewHolder> {
    ...
    public CommentsRecyclerAdapter(List<Feedback> feedbackList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        String commentMessage = feedbackList.get(position).getMessage();
        holder.setCommentMessage(commentMessage);

        String user_id = feedbackList.get(position).getUser_id();

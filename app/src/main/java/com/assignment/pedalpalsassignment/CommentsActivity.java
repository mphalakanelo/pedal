...
public class CommentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commentsRecyclerAdapter = new CommentsRecyclerAdapter(feedbackList);
        ...
        db.collection("Posts/" + postId + "/Feedback")
                            ...
                            if (!documentSnapshots.isEmpty()) {
                                ...
                                for (DocumentChange doc : documentSnapshots.getDocumentChanges()) {
                                    if (doc.getType() == DocumentChange.Type.ADDED) {
                                        ...
                                        Feedback feedback = doc.getDocument().toObject(Feedback.class);
        ...
        commentPostBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(commentMsg)) {
                    ...
                    db.collection("Posts/" + postId + "/Feedback").add(commentsMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                        @Override

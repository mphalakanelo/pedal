        ...
        db.collection("Users").document(userId).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(Settings.this, "Firestore Load Error: " + errorMessage, Toast.LENGTH_LONG).show();
                }
        ...
        setupBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(displayName)) {
                        ...
                        Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                            ...
                            public void onComplete(@NonNull Task<Uri> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    String errorMessage = task.getException().getMessage();
                                    Toast.makeText(Settings.this, "Image Error: " + errorMessage, Toast.LENGTH_LONG).show();
                                    setupProgress.setVisibility(View.INVISIBLE);
                                }
                            }
                        });
                    ...
                    Toast.makeText(Settings.this, "Profile Image and Display Name must not be empty", Toast.LENGTH_LONG).show();
                }
      ...
      //  userMap.put("image", downloadUri.toString());
        ...
        db.collection("Users").document(userId).set(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(Settings.this, "The Account Settings are updated", Toast.LENGTH_SHORT).show();
                    Intent mainIntent = new Intent(Settings.this, MainActivity.class);
                    startActivity(mainIntent);
                    finish();
                } else {
                    String errorMessage = task.getException().getMessage();
                    Toast.makeText(Settings.this, "Firestore Error: " + errorMessage, Toast.LENGTH_LONG).show();
                }
                setupProgress.setVisibility(View.INVISIBLE);
            }
        });

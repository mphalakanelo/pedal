        ...
        addPostBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(title) && !TextUtils.isEmpty(desc) && postImageUri != null) {
                    ...
                    Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                try {
                                    compressedImageFile = new Compressor(NewEvent.this)
                                            .setMaxHeight(200)
                                            .setMaxWidth(200)
                                            .setQuality(2)
                                        ...
                                        if (task.isSuccessful()) {
                                            ...
                                            db.collection("Posts").add(postMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                                ...
                                                public void onComplete(@NonNull Task<DocumentReference> task) {
                                                    if (task.isSuccessful()) {
                                                        Toast.makeText(NewEvent.this, "Post added successfully", Toast.LENGTH_LONG).show();
                                                        Intent mainIntent = new Intent(NewEvent.this, MainActivity.class);
                                                        startActivity(mainIntent);
                                                        finish();
                                                    } else {
                                                        String errorMessage = task.getException().getMessage();
                                                        Toast.makeText(NewEvent.this, "Image Error: " + errorMessage, Toast.LENGTH_LONG).show();
                                                    }
                                            ...
                                            String errorMessage = task.getException().getMessage();
                                            Toast.makeText(NewEvent.this, errorMessage, Toast.LENGTH_LONG).show();
                                        }
                                    }
                                });
                            } else {
                    ...
                    Toast.makeText(NewEvent.this, "Text Fields and Image must not be empty", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
